...
```
**4.3 Validate enrichment consistency**
...
**5.1 Distribution of creation years**
```python
...
plt.show()
```
![chart1](assets/charts/distribution_programming_lang_years.png)

**5.2 Paradigm Distribution**
```python
plt.figure(figsize=(10,5))
...
plt.show()
```
![chart2](assets/charts/primary_paradigm_distribution.png)
...
plt.show()
```
![chart3](assets/charts/typing_type_strength.png)
...
plt.show()
```
![chart4](assets/charts/origin_type_distribution.png)
...
plt.show()
```
![chart5](assets/charts/country_origin_distribution.png)
...
plt.show()
```
![chart6](assets/charts/popularity_distribution.png)
...
plt.show()
```
![chart7](assets/charts/age_language_distribution.png)

## 6. BIVARIATE ANALYSIS

**6.1 Paradigm vs Decade**
```python
...
plt.show()
```
![chart8](assets/charts/paradigm_distribution_across_decades.png)

**6.2 Typing Time vs Decade**
```python
plt.figure(figsize=(12,6))
...
plt.show()
```
![chart9](assets/charts/typing_time_decades.png)

**6.3 Origin Type vs Paradigm**
```python
plt.figure(figsize=(12,6))
...
plt.show()
```
![chart10](assets/charts/origin_type_paradigm.png)

**6.4 Popularity vs Age**
```python
...
plt.show()
```
![chart11](assets/charts/popularity_vs_age.png)

**6.5 Popularity vs Paradigm**
```python
plt.figure(figsize=(12,6))
...
plt.show()
```
![chart12](assets/charts/popularity_distribution_paradigm.png)

**6.6 Country vs Paradigm (Top Countries Only)**
```python
...
plt.show()
```
![chart13](assets/charts/paradigm_distribution_country.png)
...
```
![chart14](assets/charts/pca_projection_languages.png)
...
```
**7.5 Visualize Clusters in PCA Space**
```python
plt.figure(figsize=(10,7))
...
plt.show()
```
![chart15](assets/charts/k_means_clusters_pca.png)
...
```
**7.7 Paradigm Distribution by Cluster**
...
plt.show()
```
![chart15](assets/charts/paradigm_distrib_cluster.png)

**7.8 Typing Category by Cluster**
...
plt.show()
```
![chart16](assets/charts/Typing_Category_by_Cluster.png)

**7.9 Origin Type by Cluster**
```python
plt.figure(figsize=(12,6))
...
plt.show()
```
![chart16](assets/charts/Origin_Type_by_Cluster.png)

**7.10 Continent Distribution by Cluster**
```python
plt.figure(figsize=(12,6))
...
plt.show()
```
![chart17](assets/charts/Continent_Distribution_by_Cluster.png)
...
![icon1](assets/icons/devicon-java.svg) ![icon3](assets/icons/skill-icons-cs.svg) ![icon4](assets/icons/skill-icons-kotlin-dark.svg) ![icon2](assets/icons/skill-icons-swift.svg) ![icon2](assets/icons/skill-icons-typescript.svg)
...
![icon1](assets/icons/skill-icons-golang1.svg) ![icon3](assets/icons/skill-icons-dart-dark.svg) ![icon4](assets/icons/CarbonCopyCloner_30254.png) ![icon2](assets/icons/skill-icons_rust.svg)
...
![icon1](assets/icons/devicon-erlang.svg) ![icon3](assets/icons/devicon-prolog.svg) ![icon4](assets/icons/material-icon-theme-ocaml.svg) ![icon2](assets/icons/skill-icons-haskell-dark.svg)
...
![icon1](assets/icons/material-icon-theme-cobol.svg) ![icon3](assets/icons/material-icon-theme-pascal.svg) ![icon4](assets/icons/skill-icons-c.svg) ![icon2](assets/icons/vscode-icons-file-type-fortran.svg)
...
![icon1](assets/icons/devicon-html5-wordmark.svg) ![icon3](assets/icons/devicon-css3-wordmark.svg) ![icon4](assets/icons/devicon-sqlite-wordmark.svg) ![icon5](assets/icons/skill-icons-markdown-dark.svg) ![icon2](assets/icons/file-icons-scratch.svg)
...
plt.show()
```
![chart](assets/charts/clean_influence_network.png)

**8.2 Compute centrality metrics**
...
```
**8.3 Identify Roots, Hubs, and Bridges**
...
**9.1 The Landscape of Programming Languages**
...
**9.3 Influence Network Insights**
...
**9.5 Paradigms & Typing Philosophies**
